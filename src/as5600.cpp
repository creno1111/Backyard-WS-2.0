...
{
  int retVal = -1;
  I2C_1.beginTransmission(_ams5600_Address);
  I2C_1.write(in_adr);
  I2C_1.endTransmission();
  I2C_1.requestFrom(_ams5600_Address, (uint8_t) 1);
...
word AMS_5600::readTwoBytesTogether(int addr_in)
{
  ...
  if(!secRotarySensor){
    ...
    I2C_2.beginTransmission(_ams5600_Address);
    I2C_2.write(addr_in);
    I2C_2.endTransmission();
    I2C_2.requestFrom(_ams5600_Address, (uint8_t) 2);
    while (I2C_2.available() < 2)
      ;
